...
{
    public partial class Frm_TP6_Config_Actividades : Form
    {
        public Frm_TP6_Config_Actividades()
        {
            InitializeComponent();
        ...
        {
            ControladorTP6.GetInstance().OpcionCargarActividadesConfiguracion(this);
        }
        ...
        private void btn_Guardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ControladorTP6.GetInstance().ActualizarActividades(dtActividadesActualizadas);
