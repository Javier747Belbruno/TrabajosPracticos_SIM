...
{
    public class ModeloTP5 : IModelo
    {
        //Actividades
        ...
        {
            if (evento == Evento.Fin_Actividad_5 && C6.Cola2.Cantidad_Anterior > 0)
            {
                pedidos_realizados++;
            }
            if (evento == Evento.Fin_Actividad_3 && C6.Cola1.Cantidad_Anterior > 0)
            {
                pedidos_realizados++;
            }
        ...
        public void CalcularPunto9()
        {
            ...
            //Punto 9b
            C6.CalcularProporcionesDeEspera();
        }
        ...
        public void AgregarFila(int i, ref DataTable dtGeneral)
        {
            ...
            dtGeneral.Rows.Add(i, reloj.ToString("0.00"), evento, nro_pedido,
                                ...
                                S5.Cola.P4_Cantidad_Maxima, C6.P4_Cantidad_Maxima,
                                 ...
                                 C6.P5_Tiempo_Promedio.ToString("0.00"),
                                ...
                                S5.Cola.P6_Promedio_Pedidos_en_Cola.ToString("0.00"), C6.P6_Promedio_Pedidos_en_Cola.ToString("0.00"),
                                ...
                                C6.P9_Proporcion_Espera_Cola_1.ToString("0.00"), C6.P9_Proporcion_Espera_Cola_2.ToString("0.00"),
