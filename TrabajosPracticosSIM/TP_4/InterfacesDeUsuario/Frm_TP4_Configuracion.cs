...
{
    public partial class Frm_TP4_Configuracion : Form
    {
        public Frm_TP4_Configuracion()
        {
            InitializeComponent();
        ...
        {
            ControladorTP4.GetInstance().OpcionCargarActividadesConfiguracion(this);
        }
        ...
        private void btn_Guardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (Panel p in this.Controls.OfType<Panel>().OrderBy(c => c.Name))
                {
                    dtActividadesActualizadas.Rows.Add(i + 1, "DISTR", "PARAMS");
                ...
                ControladorTP4.GetInstance().ActualizarActividades(dtActividadesActualizadas);
