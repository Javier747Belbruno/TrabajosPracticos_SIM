...
{
    public partial class Frm_TP5_Configuracion : Form
    {
        public Frm_TP5_Configuracion()
        {
            InitializeComponent();
        ...
        {
            ControladorTP5.GetInstance().OpcionCargarActividadesConfiguracion(this);
        }
        ...
        private void btn_Guardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ControladorTP5.GetInstance().ActualizarActividades(dtActividadesActualizadas);
